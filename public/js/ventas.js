...
(function() {
  var AuxObjAttribs, ShoppingCart, ctnVentasJq, formHtmlEditarItem, htmlCliente, item, msgCarritoJq, numItemsJq, tablaVentas, _i, _len;
  ...
  ShoppingCart = (function() {
    ...
    ShoppingCart.prototype.calcSubtotal = function() {
      var index, sum;
      index = this.tipoPrecio === 'recibo' ? 4 : 5;
      sum = 0;
      this.tBodyJq.find('tr').each(function(i) {
  ...
  $(document).ready(function() {
    ...
    ctnVentasJq.find('ul.dropdown-cols input:checkbox').on('click', function(event) {
      var column;
    ...
    actualNum = 0;
    carouselItem = ctnVentasJq.find('div#item-venta').carousel({
      interval: false
    });
    ctnVentasJq.find('ol.breadcrumb').on('click', 'a', function(evt) {
      var num;
      evt.preventDefault();
    ...
    ctnVentasJq.find('input.tipo_precio').on('change', function() {
    ...
    shoppingCart.addTo(ctnVentasJq.find('div.table-responsive:eq(1)'));
