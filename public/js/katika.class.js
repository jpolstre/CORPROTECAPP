var Katika = (function() {
	...
	MensajeError = (function() {
		...
		function MensajeError(elementoJq, mensaje) {
			...
			html = "<span class='help-inline' style='display:none;color: chocolate;cursor:pointer;font-size: 13px;'>*" + mensaje + "</span>";
	...
	Validador = (function() {
		...
		Validador.prototype.addItem = function(itemJq){
			var elemento;
			elemento = new Object();
			elemento.jq = itemJq;
			elemento.reglas = (itemJq.attr('validar')).split(',');
			elemento.mensajeError = new MensajeError(itemJq, 'msg por defecto');
			this.inputs.push(itemJq);
		...
		Validador.prototype.validarForm = function() {
			var _this = this;
			return this.formulario.on('submit', function(e) {
				e.preventDefault();
		...
		Validador.prototype.validarInputs = function() {
			var this_;
			this_ = this;
			return this.formulario.on('keyup change', '[validar]', function(e) {
