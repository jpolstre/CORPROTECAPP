...
(function() {
  var AuxObjAttribs2, ShoppingCart2, ctnComprasJq, formHtmlEditarItem2, htmlProveedor, item, msgCarritoJq2, numItemsJq2, _i, _len;
  ...
  ShoppingCart2 = (function() {
    ...
    ShoppingCart2.prototype.shopp = function() {
      var modalProveedor;
    ...
    ShoppingCart2.prototype.restar = function() {
      this.itemsInCart = [];
      this.numRows = 0;
      this.numItems = 0;
      numItemsJq2.text(this.numItems);
      this.tBodyJq.html('');
      this.jq.hide();
      return msgCarritoJq2.show();
    };

    ShoppingCart2.prototype.cancelShopp = function() {
      var modalConfirm;
        ...
        accionSi: (function(_this) {
          return function() {
            return modalConfirm.cerrar(function() {
              ...
              _this.numRows = 0;
              _this.numItems = 0;
              numItemsJq2.text(_this.numItems);
              _this.tBodyJq.html('');
              return _this.jq.fadeOut('fast', function() {
                return msgCarritoJq2.fadeIn('fast');
              });
            });
          };
        })(this),
    ...
    ShoppingCart2.prototype.sumColumn = function(index) {
      var sum;
      sum = 0;
    ...
    ShoppingCart2.prototype.editRow = function(trJq) {
      ...
      modalEditar = new Modal({
        ...
        despuesDeMostrar: function(modalJq) {
          ...
          for (i = _j = 0, _len1 = AuxObjAttribs2.length; _j < _len1; i = ++_j) {
            item = AuxObjAttribs2[i];
            if (!(item !== 'subtotal')) {
              continue;
            }
          ...
          return function(formJq) {
            ...
            if (cantidad * 1 === seriesArr.length * 1 || seriesJq.val() === '----------') {
              return modalEditar.cerrar(function() {
                ...
                return numItemsJq2.text(_this.numItems);
              });
            } else {
              return new Alerta({
                tipo: 'error',
    ...
    ShoppingCart2.prototype.addRow = function(rowObj) {
    ...
    ShoppingCart2.prototype.delRow = function(rowJq) {
      var cantidad;
    ...
    ShoppingCart2.prototype.serialize = function(proveedor) {
      var gthis, resultArr;
      resultArr = [];
      gthis = this;
      this.tBodyJq.find('tr').each(function(i) {
  ...
  $(document).ready(function() {
    var actualNum, btnClearJq, btnSearchJq, btnsTabs, cantidadJq, carouselItem, contTablaCompJq, ctnsTabs, formCompraJq, imputsFormCompraJq, inputSearchJq, itemElegido, procAddToCard, procSeries, serializeForm, showHideMenujq, tablaCompras, tablaComprasJq, titlePanelJq, valArray, validador;
    ...
    ctnComprasJq.find('ul.dropdown-cols input:checkbox').on('click', function(event) {
      var column;
    ...
    actualNum = 0;
    carouselItem = ctnComprasJq.find('div#item-compra').carousel({
      interval: false
    });
    ...
    btnClearJq = ctnComprasJq.find('button#btn-clear-form').on('click', function(evt) {
    ...
    return ShoppingCart2.addTo(ctnComprasJq.find('div.table-responsive:eq(1)'));
  });
